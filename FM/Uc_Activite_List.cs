...
{
    public partial class Uc_Activite_List : UserControl
    {
        private static Uc_Activite_List UserRAct;
        private Db_EleveBookEntities4 db;
        public static int IDselect;

      
            
        public string paraUC,aguerrissemntUC, corveteEte, semaineEleve, gantBlanc, permisConduire, najeur, fumeur;    

    
        public Uc_Activite_List()
        {
            InitializeComponent();
        ...
        private void Uc_Activite_List_Load(object sender, EventArgs e)
        {
        ...
        public static Uc_Activite_List Instance
        {
            get
            {
                if (UserRAct == null)
                {
                    UserRAct = new Uc_Activite_List();
                }
                return UserRAct;
            }
        }
        ...
        public void ActualiserDataGridViewAct()
        {
            ...
            foreach (var s in db.R_Activites)
            {
        ...
        {
            FRM_ActiviteAjouterModifier frc = new FRM_ActiviteAjouterModifier(this);
        ...
        {
            R_Activites RA = new R_Activites();
            ...
            {
                FRM_ActiviteAjouterModifier frmRA = new FRM_ActiviteAjouterModifier(this);
                ...
                for (int i = 0; i < dgvRAList.Rows.Count; i++)
                {
                    if ((bool)dgvRAList.Rows[i].Cells[0].Value == true) // si ligne selectionnée
                    {
                        ...
                        RA = db.R_Activites.SingleOrDefault(s => s.Id == IDselect);
                        ...
                        if (RA != null)
                        {
                            ...
                            if (paraUC == "X")
                                frmRA.cbPara.Checked = true;
                            else
                                frmRA.cbPara.Checked = false;
            ...
            else
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    for (int i = 0; i < dgvRAList.Rows.Count; i++) //nombre de ligne selectionnées
                    {
                        ...
                        {
                            CL.CLS_ActivitesTable cLS_Act = new CL.CLS_ActivitesTable();
            ...
            try
            {
                using (SaveFileDialog SFD = new SaveFileDialog() { Filter = "Excel Workbook | *.xlsx", ValidateNames = true })
                {
                    if (SFD.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        var lisetRE = db.R_Activites.ToList();
                        int i = 2;
        ...
        private void btnRapportTout_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db = new Db_EleveBookEntities4();
                var listREEleves = db.R_Activites.ToList();
                frmRE.RPafficher.LocalReport.ReportEmbeddedResource = "Eleve_Book.Rapport.rpt_ra_tout.rdlc";
        ...
        private void btnRapportNajeur_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db = new Db_EleveBookEntities4();
                var listREEleves = db.R_Activites.ToList();
                frmRE.RPafficher.LocalReport.ReportEmbeddedResource = "Eleve_Book.Rapport.rpt_ra_najeur.rdlc";
                frmRE.RPafficher.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", listREEleves));
                //ReportParameter date = new ReportParameter("date", DateTime.Now.ToString());
                //frmRE.RPafficher.LocalReport.SetParameters(new ReportParameter[] { date });
                frmRE.RPafficher.RefreshReport();
        ...
        private void btnRapportFumeur_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db = new Db_EleveBookEntities4();
                var listREEleves = db.R_Activites.ToList();
                frmRE.RPafficher.LocalReport.ReportEmbeddedResource = "Eleve_Book.Rapport.rpt_ra_fumeur.rdlc";
                frmRE.RPafficher.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", listREEleves));
                //ReportParameter date = new ReportParameter("date", DateTime.Now.ToString());
                //frmRE.RPafficher.LocalReport.SetParameters(new ReportParameter[] { date });
                frmRE.RPafficher.RefreshReport();

...
{
    class CLSL_R_ElementairesTable
    {
        private Db_EleveBookEntities4 db = new Db_EleveBookEntities4();
        public LR_ElementairesTable RE; //table eleve rens.elementaire
        ...
        public bool Ajouter_Eleve(String Nom, String Prenom, String Telephone, String Email, String Genre, String Nationalité, String Religion, String Adresse, Byte[] imageEleve,String Autres)
        {
            ...
            if (db.LR_ElementairesTable.SingleOrDefault(s => s.Nom_Eleve == Nom && RE.Prenom_Eleve == Prenom) == null) //verifier s'il existe
            {
               
                db.LR_ElementairesTable.Add(RE); //ajouter C a table
        ...
        public void Modifier_Eleve(int idE,String NomE, String PrenomE, String TelephoneE, String EmailE, String GenreE, String NationaliteE, String ReligionE, String AdresseE, Byte[] ImageE,String Autres)
        {
            ...
            RE = db.LR_ElementairesTable.SingleOrDefault(s => s.Id == idE);
            if (RE != null)
            {
        ...
        {
            RE = new LR_ElementairesTable();
            RE = db.LR_ElementairesTable.SingleOrDefault(s => s.Id == id);
            if (RE != null)  //if existe
            {
                db.LR_ElementairesTable.Remove(RE);
                db.SaveChanges();
            }
        }
        #endregion
